...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-4 py-10 sm:px-5">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-6 shadow-sm sm:p-7">
        ...
        <button
          onClick={google}
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg border border-border-strong px-4 py-2.5 font-medium text-secondary transition hover:bg-background"
        >
          <GoogleIcon /> Continuar con Google
        </button>

        <div className="my-4 flex items-center gap-3 text-xs text-tertiary">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border-strong px-3 py-2.5 outline-none focus:border-accent"
            />
          </div>
          <div>
