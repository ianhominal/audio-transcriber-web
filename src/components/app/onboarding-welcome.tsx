...
export function OnboardingWelcome({
  ...
  return (
    ...
    >
      <div
        className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-background text-3xl"
        aria-hidden="true"
      >
        👋
      </div>
      ...
      <p className="mx-auto mt-6 max-w-lg text-sm text-secondary">
      ...
      <div className="mt-7 flex flex-col items-center gap-3">
        <Link href={recordHref} onClick={markOnboardingSeen} className={buttonClasses({ size: "lg" })}>
          🎙️ Grabá tu primera nota
        </Link>
        <Link
          href={uploadHref}
